...
output_layers = [layer_names[i - 1] for i in net.getUnconnectedOutLayers()]  # Adjusted indexing
...
while True:
    ...
    for i in range(len(boxes)):
        if i in indexes:
            ...
            cv2.putText(frame, label + " " + confidence_score, (x, y + 30), cv2.FONT_HERSHEY_PLAIN,
                        3, (255, 255, 255), 3)
